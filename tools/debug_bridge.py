...
def main() -> int:
    ...
    parser.add_argument("--joint", choices=JOINT_NAMES, default="shoulder_flexion")
    ...
    try:
        ...
        raw = robot.read_bridge_joint_state(args.joint)
        ...
        return 0 if raw.wrapper_status == 0 else 1
    except Exception as exc:
        print(f"ERROR: {exc}", file=sys.stderr)
        return 1
    finally:
        # close() requests Servo Off but never Servo On or sends a position command.
        robot.close()
