 ...
 * 功能：对电机设置速度模式，使能电机，设置电机速度值，循环获取实际快速帧pvctfast
 * @author  xufuliang
 * @date    2026-03-13
 */
#include <stdio.h>
...
int main(int argc, char* argv[]) {
    ...
    while (1)
    {
        ...
        if(!robot_motor_getVelPID(motor,&VelP,&VelI,&VelD))
        {
        ...
        if(!robot_motor_setVelPID(motor,VelP,VelI,VelD))
        {
